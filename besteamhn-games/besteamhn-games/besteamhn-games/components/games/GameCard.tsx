...
const GAME_COMPONENTS: Record<GameId, React.ComponentType<any>> = {
  'quiz-battle': dynamic(() => import('./QuizBattle'), { ssr: false }),
  'memory-match': dynamic(() => import('./MemoryMatch'), { ssr: false }),
  'drag-drop': dynamic(() => import('./DragDropChallenge'), { ssr: false }),
  'speed-challenge': dynamic(() => import('./SpeedChallenge'), { ssr: false }),
  'sky-jump': dynamic(() => import('./SkyJump'), { ssr: false }),
  'color-dash': dynamic(() => import('./ColorDash'), { ssr: false }),
};
